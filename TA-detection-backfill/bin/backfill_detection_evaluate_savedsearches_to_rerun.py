...
if __name__ == '__main__':
    ...
    for result in results:
        ...
        outage_period_earliest = result["outage_period_earliest"]
        outage_period_latest = result["outage_period_latest"]
        ...
        for savedsearch in savedsearches:
            ...
            if filter_timestamp.search(outage_period_earliest):
                # It's a timestamp, convert it to float
                ...
                # outage_period_earliest can't be a pattern, exit
                logger_file.error("060","Outage earliest period must be a timestamp, got '{0}'".format(outage_period_earliest))
                sys.exit(60)
